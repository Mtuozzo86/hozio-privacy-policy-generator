  ...
  return (
    <div className="App">
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to {company}, {county}, {state}.
          </p>
        </li>
        <li>
          <p>
      ...
      <p>
        ...
        communications will vary based on the nature of the information and your
        interaction with our Service.
      </p>
      <p>
        <strong>Opt-out Option:</strong> You will have the option to opt-out of
        receiving SMS and email communications from us at any time. Each SMS and
        email will include instructions on how to unsubscribe.
      </p>
      <p>
        <strong>No Requirement for Consent:</strong> Consent to receive SMS and
        email communications is not a requirement to use our Service. You can
        choose to opt out of these communications and still access and use our
        Service.
      </p>
      ...
      <p>
        ...
        communications. Your data will be handled in accordance with our Privacy
        Policy, ensuring its security and confidentiality.
      </p>
