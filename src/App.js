...
export default function App() {
  ...
  function handleCopy() {
    ...
    range.selectNodeContents(privacyContentRef.current);
    ...
    <div className="App">
      ...
      <div className="privacy-policy">
        ...
        <div ref={privacyContentRef} id="privacy-content">
          ...
          <ul>
            ...
            <li>
              <p>
                ...
                in this Agreement) refers to {company}, {county}, {state}.
              </p>
            </li>
            <li>
              <p>
            ...
            <li>
              <p>
                <strong>Country</strong> refers to: {state}, {country}.
              </p>
            </li>
            <li>
              <p>
          ...
          <h3>Communication Preferences and Privacy</h3>
          <p>
            When you fill out forms on our Service, you may opt to receive SMS
            and email communications from us. By accepting our Privacy Policy,
            you acknowledge and agree to the following terms regarding these
            communications:
          </p>
          <p>
            <strong>Consent to Receive Communications:</strong> By submitting
            your contact information and accepting the Privacy Policy, you
            explicitly consent to receive SMS and email communications from us,
            which may include but are not limited to updates, news, offers, and
            service-related information.
          </p>
          <p>
            <strong>Frequency of Communications:</strong> The frequency of these
            communications will vary based on the nature of the information and
            your interaction with our Service.
          </p>
          <p>
            <strong>Opt-out Option:</strong> You will have the option to opt-out
            of receiving SMS and email communications from us at any time. Each
            SMS and email will include instructions on how to unsubscribe.
          </p>
          <p>
            <strong>No Requirement for Consent:</strong> Consent to receive SMS
            and email communications is not a requirement to use our Service.
            You can choose to opt out of these communications and still access
            and use our Service.
          </p>

          <p>
            <strong>Data Usage and Protection:</strong> We will use your contact
            information solely for the purpose of sending you the opted
            communications. Your data will be handled in accordance with our
            Privacy Policy, ensuring its security and confidentiality.
          </p>
